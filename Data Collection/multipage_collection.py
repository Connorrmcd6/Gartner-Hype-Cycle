...
# start_list = ['2018-01-15T00:00:00.000Z']
# end_list = ['2018-01-16T00:00:00.000Z']
    ...
    while flag:
        ...
        if 'next_token' in json_response['meta']:
            ...
            if result_count is not None and result_count > 0 and next_token is not None:
                ...
                df.to_sql('blockchain', con=engine, if_exists='append', index=False, chunksize=1000)
...
os.system("say 'collection complete'") 
